...
<label style="color:#69F">影片草稿夾</label>
    ...
    <ul>
				...
				while($row = $result->fetch_array(MYSQL_ASSOC)){
				 ...
				 if($found){
                    $UrlArr = explode("=" , $url);
				    $youtube_n = $UrlArr[1];
					echo "<li style='list-style:none;'><div class='temp_movie'><a href='temp_media_show.php?user_media_id=$user_media_id'><div><img src='http://img.youtube.com/vi/$youtube_n/0.jpg' class='youtube' name='$url' style='width:196px;height:110px;'/></div></a><h3 class='movie_title'><a href='temp_media_show.php?user_media_id=$user_media_id' style='text-decoration:none;color:#69C'>$url</a></h3></div></li>";
				}else{
					echo "<li style='list-style:none;'><div class='temp_movie'><a href='temp_media_show.php?user_media_id=$user_media_id' style='text-decoration:none;'><div><img src='../user_pics/$url.jpg' style='width:196px;height:110px;'/></div></a><h3 class='movie_title'><a href='temp_media_show.php?user_media_id=$user_media_id' style='text-decoration:none;color:#69C'>$url</a></h3></div></li>";
				}
                }
